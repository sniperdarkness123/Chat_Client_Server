...
//			printWriter.close();
			...
			JOptionPane.showMessageDialog(this, "Máy chủ đã được lưu.");
	...
	public MainFrame() throws Exception {
		...
		panel_1.setBorder(new TitledBorder(
				...
				"Server", TitledBorder.LEADING, TitledBorder.TOP, null, SystemColor.textHighlight));
	...
	private void connectChat() {
		...
		int n = JOptionPane.showConfirmDialog(this, "Bạn có muốn kết nối với tài khoản này không?", "Kết nối",
		...
		if (n == 0) {
			...
			if (name.equals(nameUser)) {
				Tags.show(this, "Phần mềm này không hỗ trợ chức năng trò chuyện", false);
				return;
			}
			...
			Tags.show(this, "Không tìm thấy bạn bè. Vui lòng đợi để cập nhật danh sách bạn bè của bạn", false);
		}
	}
